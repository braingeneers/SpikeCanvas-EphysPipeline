...
DEFAULT_JOBS = {"batch":
                    {"image": "braingeneers/ephys_pipeline:v0.57",
                     "args": "./run.sh",
                     "cpu_request": 12,
                     "memory_request": 32,
                     "disk_request": 400,
                ...
                "chained": {
                    0: {"image": "braingeneers/ephys_pipeline:v0.57",  # for running individual recording
                        "args": "./run.sh",
                        "cpu_request": 12,
                        "memory_request": 32,
                        "disk_request": 400,
...
IMG_JOB_LOOPUP = {
    ...
    "braingeneers/ephys_pipeline:v0.57": "Ephys Pipeline (Kilosort2, Auto-Curation, Visualization)",
