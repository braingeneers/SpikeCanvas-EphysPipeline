...
DEFAULT_JOBS = {"batch":
                ...
                "chained": {
                    0: {"image": "braingeneers/ephys_pipeline:v0.75",  # for running individual recording
                        "args": "./run.sh",
                        "cpu_request": 12,
                        "memory_request": 32,
                        "disk_request": 400,
...
IMG_JOB_LOOPUP = {
    ...
    "braingeneers/ephys_pipeline:v0.75": "Ephys Pipeline (Kilosort2, Auto-Curation, Visualization)",
